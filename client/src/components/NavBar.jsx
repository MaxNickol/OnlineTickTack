    ...
    if(context.isAuth) {
        ...
        block = (
                <>
                    ...
                    <div className="search ml-3 d-flex flex-row justify-content-center align-items-center">
                        <TagsInput value={tags} onChange={onChange} className="form-control ml-5 text-center d-flex flex-row align-items-center" />
        ...
        return(
            <>
            <nav className="navbar navbar-expand navbar-light bg-success d-flex flex-row justify-content-between align-items-center">
               {block}
